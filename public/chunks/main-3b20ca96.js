...
function instance($$self, $$props, $$invalidate) {
	...
	const routes = {
		"/": Home,
		"/links": wrap$1({
			asyncComponent: () => Promise.resolve().then(function () { return require('./index-7d0aca9b.js'); })
		}),
		"/lessons": wrap$1({
			asyncComponent: () => Promise.resolve().then(function () { return require('./index-7b95193e.js'); }),
			conditions: [() => dbStatus == "success"],
			loadingComponent: Loading,
			loadingParams: { text: "Loading lessons..." }
		}),
		"/lesson/:id": wrap$1({
			asyncComponent: () => Promise.resolve().then(function () { return require('./index-13020f3e.js'); })
		}),
		"/new-lesson": wrap$1({
			asyncComponent: () => Promise.resolve().then(function () { return require('./index-fe81aa8a.js'); })
		})
	};
...
//# sourceMappingURL=main-3b20ca96.js.map
