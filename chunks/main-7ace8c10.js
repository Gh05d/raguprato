...
function instance($$self, $$props, $$invalidate) {
	...
	const routes = {
		"/": Home,
		"/links": wrap$1({
			asyncComponent: () => import('./index-4314f49d.js')
		}),
		"/lessons": wrap$1({
			asyncComponent: () => import('./index-28dcfee4.js'),
			conditions: [() => dbStatus == "success"],
			loadingComponent: Loading,
			loadingParams: { text: "Loading lessons..." }
		}),
		"/lesson/:id": wrap$1({
			asyncComponent: () => import('./index-294d6b52.js')
		}),
		"/new-lesson": wrap$1({
			asyncComponent: () => import('./index-164c9d99.js')
		})
	};
...
export { binding_callbacks as $, validate_each_argument as A, empty as B, destroy_each as C, set_input_value as D, null_to_empty as E, toggle_class as F, onDestroy as G, query_selector_all as H, spotifyToken as I, create_component as J, claim_component as K, mount_component as L, prop_dev as M, transition_in as N, transition_out as O, destroy_component as P, to_number as Q, location as R, SvelteComponentDev as S, push as T, src_url_equal as U, group_outros as V, check_outros as W, bubble as X, createEventDispatcher as Y, stop_propagation as Z, is_function as _, space as a, bind as a0, add_flush_callback as a1, app as a2, children as b, claim_element as c, dispatch_dev as d, element as e, claim_text as f, detach_dev as g, claim_space as h, init as i, add_location as j, attr_dev as k, insert_hydration_dev as l, append_hydration_dev as m, noop as n, validate_store as o, component_subscribe as p, onMount as q, db as r, safe_not_equal as s, text as t, globals as u, validate_slots as v, set_data_dev as w, listen_dev as x, prevent_default as y, run_all as z };
//# sourceMappingURL=main-7ace8c10.js.map
